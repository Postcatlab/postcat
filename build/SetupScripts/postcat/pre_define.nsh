...
!define /ifndef PRODUCT_VERSION        	   "0.3.6.0"				#版本号	
!define /ifndef INSTALL_OUTPUT_NAME    		"Postcat-Setup-0.3.6.exe"	#默认的安装包名称，在bat中控制传入  
!define /ifndef INSTALL_LOCATION_KEY 		    "InstallLocation"				#默认的注册表中安装位置的key值    
