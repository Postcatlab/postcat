...
import { ExtensionDetailComponent } from 'pc/browser/src/app/pages/extension/detail/extension-detail.component';
import { DownloadCountFormaterPipe } from 'pc/browser/src/app/pages/extension/download-count-formater.pipe';
