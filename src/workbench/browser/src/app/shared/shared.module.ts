...
import { SchemaFormComponent } from 'eo/workbench/browser/src/app/shared/components/schema-form/schema-form.component';
...
const COMPONENTS = [DownloadClientModalComponent, ExtensionAppComponent, SchemaFormComponent];
