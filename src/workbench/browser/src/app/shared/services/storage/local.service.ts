  ...
  api_workspaceMemberQuit({ workspaceID }) {
    ...
    return new Promise((resolve) => {
      this.create(this.undefined, { workspaceID })
        .then(({ status, ...data }: any) => {
          console.log(
            '%c workspace - memberQuit 接口调用成功 %c',
            SuccessStyle,
            ''
          )
          if (status === 200) {
        ...
        .catch((error) => {
          console.log(
            '%c workspace - memberQuit 接口调用失败 %c',
            ErrorStyle,
            ''
          )
          resolve([null, error])
  ...
  api_workspacePermission({ workspaceID }) {
    ...
    return new Promise((resolve) => {
      this.load(this.undefined, { workspaceID })
        .then(({ status, ...data }: any) => {
          console.log(
            '%c workspace - permission 接口调用成功 %c',
            SuccessStyle,
            ''
          )
          if (status === 200) {
        ...
        .catch((error) => {
          console.log(
            '%c workspace - permission 接口调用失败 %c',
            ErrorStyle,
            ''
          )
          resolve([null, error])
