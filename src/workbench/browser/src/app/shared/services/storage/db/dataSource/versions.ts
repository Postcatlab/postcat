import type { DataSourceInstance } from 'eo/workbench/browser/src/app/shared/services/storage/db/dataSource';
import { migrationToV3, migrationToV4 } from 'eo/workbench/browser/src/app/shared/services/storage/db/dataSource/migration';
