  ...
  template: ` <nz-modal
    ...
    >
      <ng-container *nzModalContent>
        ...
        <span style="color: #1890ff" (click)="textbxqwjoCallback()" i18n>
          open the settings
        </span>
...
export class UserModalComponent implements OnInit {
  ...
  async btnpjneucCallback() {
    // * click event callback

    // * 关闭弹窗
    this.isSyncModalVisible = false
  }
  async btnuks4l4Callback() {
    // * click event callback
  ...
  async btnds4aviCallback() {
    // * click event callback

    // * 关闭弹窗
    this.isCheckConnectModalVisible = false
  }
  async btn4tjgogCallback() {
    // * click event callback
  ...
  async e0t7ma3Callback() {
    // * nzAfterClose event callback

    // * Clear Username form
    this.validateUsernameForm.reset()
  }
  async btnryzxm4Callback() {
    // * click event callback
  ...
  async btnxia97sCallback() {
    // * click event callback

    // * 关闭弹窗
    this.isAddWorkspaceModalVisible = false
  }
  async btnir0idqCallback() {
    // * click event callback
