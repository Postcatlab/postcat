...
@Component({
  ...
  template: `<h2 class="text-lg flex justify-between items-center">
    ...
    <section class="w-1/2">
      ...
      <button nz-button class="w-[84px]" nzType="primary" (click)="btngps62mCallback()" i18n>Save</button>
      ...
      <form nz-form [formGroup]="validatePasswordForm" nzLayout="vertical">
        ...
        <nz-form-item>
          <nz-form-control nzErrorTip="Please input your confirm new password !">
            <nz-form-label [nzSpan]="24" i18n>Confirm new password</nz-form-label>
            <input
              type="password"
              nz-input
    ...
    <button nz-button class="w-[84px]" nzType="primary" (click)="btn9jxp38Callback()" i18n>Reset</button>
    <section class="h-4"></section> `,
})
