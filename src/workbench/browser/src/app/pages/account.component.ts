...
@Component({
  ...
  template: `<h2 class="text-lg flex justify-between items-center">
    ...
    <h2 id="eoapi-account-username" class="text-lg flex justify-between items-center">
      ...
      <form nz-form [formGroup]="validateUsernameForm" nzLayout="vertical">
        <nz-form-item>
          <nz-form-control nzErrorTip="Please input your username !">
            <input type="text" nz-input formControlName="username" placeholder="" i18n-placeholder nzRequired />
          </nz-form-control>
        </nz-form-item>
      </form>
      <button nz-button class="w-[120px]" nzType="primary" (click)="btn6tsxlcCallback()" i18n>Save</button>
      <section class="h-4"></section>
    </section>
    <h2 id="eoapi-account-password" class="text-lg flex justify-between items-center">
      ...
      <form nz-form [formGroup]="validatePasswordForm" nzLayout="vertical">
        <nz-form-item>
          <nz-form-control nzErrorTip="Please input your current password !">
            ...
            <input type="password" nz-input formControlName="oldPassword" placeholder="" i18n-placeholder nzRequired />
          </nz-form-control>
        </nz-form-item>
        ...
        <nz-form-item>
          <nz-form-control nzErrorTip="Please input your new password !">
            ...
            <input type="password" nz-input formControlName="newPassword" placeholder="" i18n-placeholder nzRequired />
          </nz-form-control>
        </nz-form-item>

        <nz-form-item>
          <nz-form-control nzErrorTip="Please input your confirm new password !">
            <nz-form-label [nzSpan]="12" i18n>Confirm new password</nz-form-label>
            <input
              type="password"
              nz-input
    ...
    <button nz-button class="w-[120px]" nzType="primary" (click)="btn6po23nCallback()" i18n>Reset</button>
    <section class="h-4"></section> `,
})
